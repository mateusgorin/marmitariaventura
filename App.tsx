...
const App: React.FC = () => {
  return (
    <div className="relative min-h-screen flex flex-col items-center pt-8 pb-16 px-5 md:px-6">
      ...
      {/* THE 4 MASTER BLOCKS - Mobile Grid Optimization */}
      <main className="w-full max-w-4xl grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 justify-center">
        ...
        <a 
          ...
          className="aspect-square group relative flex flex-col items-center justify-center text-center bg-[#232B35] card-grain rounded-[2rem] md:rounded-[2.5rem] shadow-[0_15px_30px_-12px_rgba(0,0,0,0.3)] p-4 transition-all duration-500 hover:scale-[1.03] active:scale-95 animate-reveal delay-1"
        >
          <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center mb-2.5 md:mb-3 text-white transform group-hover:-translate-y-1 transition-transform duration-500 relative z-10">
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="aspect-square group flex flex-col items-center justify-center text-center bg-[#232B35] card-grain rounded-[2rem] md:rounded-[2.5rem] shadow-[0_15px_30px_-12px_rgba(0,0,0,0.3)] p-4 transition-all duration-500 hover:bg-[#25D366] active:scale-95 animate-reveal delay-2"
        >
          <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center mb-2.5 md:mb-3 text-white transform group-hover:scale-105 transition-transform duration-500 relative z-10">
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="aspect-square group flex flex-col items-center justify-center text-center bg-[#232B35] card-grain rounded-[2rem] md:rounded-[2.5rem] shadow-[0_15px_30px_-12px_rgba(0,0,0,0.3)] p-4 transition-all duration-500 hover:bg-[#111827] active:scale-95 animate-reveal delay-3"
        >
          <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center mb-2.5 md:mb-3 text-white transform group-hover:rotate-12 transition-transform duration-500 relative z-10">
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="aspect-square group flex flex-col items-center justify-center text-center bg-[#232B35] card-grain rounded-[2rem] md:rounded-[2.5rem] shadow-[0_15px_30px_-12px_rgba(0,0,0,0.3)] p-4 transition-all duration-500 active:scale-95 animate-reveal delay-4"
        >
          <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center mb-2.5 md:mb-3 text-white transform group-hover:scale-105 transition-transform duration-500 relative z-10">
      ...
      {/* FOOTER: THE SIGNATURE - Simplified for mobile */}
